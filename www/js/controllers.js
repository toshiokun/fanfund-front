...
.component('introduce', {
  ...
  controller: ['$scope', function($scope){
    ...
    {
      "key" : "hogehoge" ,
      "values" : [ [ 1025409600000 , 30.041422681023], [ 1335758400000 , 30.041422681023]],
      "color": "#000000"
    }]
...
.controller('LoginCtrl',['$http', '$scope', '$state', 'HttpService', function($http, $scope, $state, httpService) {
